...
interface EnterTeamDetailProps {
  teamName: string;
  ...
  teamManager: string;
  setTeamManager: (name: string) => void;
}

const EnterTeamDetail: React.FC<EnterTeamDetailProps> = ({
  teamName,
  setTeamName,
  primaryColor,
  setPrimaryColor,
  ...
  const handleCoachChange = (e: ChangeEvent<HTMLInputElement>) => {
    const name = e.target.value;
    if (name.length <= 1) {
      setCoachError(true);
    } else {
  ...
  const handleTeamManagerChange = (e: ChangeEvent<HTMLInputElement>) => {
    const name = e.target.value;
    if (name.length <= 1) {
      setTeamManagerError(true);
    } else {
      ...
      <div className="flex h-full">
        <div className="flex items-center space-x-4">
          <div>
            ...
            />
            {teamNameError && (
              <p className="text-red-500 text-xs italic">Team name must be 2 characters long</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {coachError && (
              <p className="text-red-500 text-xs italic">The name for the coach must be at least 2 characters long</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {teamManagerError && (
              <p className="text-red-500 text-xs italic">The name for the Team Manager must be at least 2 characters long</p>
            )}
          </div>
        </div>
      </div>
