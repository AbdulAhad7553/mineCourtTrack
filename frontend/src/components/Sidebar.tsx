        ...
        <ul className="space-y-2 font-medium">
            <li>
              <button className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group w-full">
                ...
                <span onClick={() => { handleDashboard(); handleSetActivePage('/dashboard'); }} className="ms-3 flex-1 whitespace-nowrap">Dashboard</span>
                {/* <span className="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-gray-200 rounded-full dark:bg-gray-700 dark:text-gray-300">Pro</span> */}
              </button>
            </li>


            <li>
              <button onClick={handleEditTeams} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group w-full">
            ...
            <li>
              <button onClick={handleMatchHistory} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group w-full">
            ...
            <li>
              <button onClick={handleViewPlayerStats} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group w-full">
            ...
            <li>
              <button onClick={handleLeaderboards} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group w-full">
          ...
          {/* Add similar Link components for other sidebar items */}

          <li>
              <button onClick={handleLogout} className="mt-32 flex items-center p-2 text-gray-900 bg-red-500 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-red-300 group w-full">
